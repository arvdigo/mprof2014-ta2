...
<legend>Identificação:</legend>
	...
	<div class="form-group ${hasErrors(bean: pessoaInstance, field: 'data_nascimento', 'error')} required">
		...
		<g:field class="form-control datepicker" type="none" name="data_nascimento" required="" precision="day"  value="${pessoaInstance?.data_nascimento}"  />
	</div>
	...
	<div class="form-group ${hasErrors(bean: pessoaInstance, field: 'senha', 'error')} required">
		<label for="senha" class="control-label">
			<g:message code="pessoa.senha.label" default="Senha" />
			<span class="required-indicator">*</span>
		</label>
		<g:passwordField class="form-control" type='senha' name="senha" required="" />
	</div>
	
	<div class="form-group ${hasErrors(bean: pessoaInstance, field: 'confirmarSenha', 'error')} required">
		<label for="confirmarSenha" class="control-label">
			<g:message code="pessoa.confirmarSenha.label" default="Confirme a Senha" />
			<span class="required-indicator">*</span>
		</label>
		<g:passwordField class="form-control" type='confirmarSenha' name="confirmarSenha" required="" />
	</div>
...
<legend>Contato:</legend>
	...
	<div class="form-group ${hasErrors(bean: pessoaInstance, field: 'telefone', 'error')}">
		<label for="telefone" class="control-label">
			<g:message code="pessoa.telefone.label" default="Telefone" />
		</label>
		<g:textField class="form-control" name="telefone" value="${pessoaInstance?.telefone}"/>
	</div>
	...
	<div class="form-group ${hasErrors(bean: pessoaInstance, field: 'numero', 'error')}">
